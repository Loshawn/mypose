...
class WholebodyDataset(JointsDataset):
    """
    "keypoints": {
        0: "nose",
        1: "left_eye",
            ...
            result = [
                {
                    ...
                    "category_id": cat_id,
                    "keypoints": key_points[k, :17 * 3].tolist(),
                    "foot_kpts":
                    key_points[k, 17 * 3:23 * 3].tolist(),  # 6 points
                    "face_kpts":
                    key_points[k, 23 * 3:91 * 3].tolist(),  # 68 points
                    "lefthand_kpts":
