...
class Eval_wholebody:
    ...
    def _prepare(self):
        ...
        for dt in dts:
            d = np.array(dt['keypoints'] + dt['foot_kpts'] + dt['face_kpts'] +
                         dt['lefthand_kpts'] + dt['righthand_kpts'])
            vd = d[2::3]
    ...
    def computeIoU(self, imgId, catId):
        ...
        if len(gt) == 0 and len(dt) == 0:
            return []
        inds = np.argsort([-d['wholebody_score'] for d in dt],
                          kind='mergesort')
    ...
    def computeOks(self, imgId, catId):
        ...
        inds = np.argsort([-d['wholebody_score'] for d in dts],
                          kind='mergesort')
    ...
    def evaluateImg(self, imgId, catId, aRng, maxDet):
        ...
        dtind = np.argsort([-d['wholebody_score'] for d in dt],
                           kind='mergesort')
