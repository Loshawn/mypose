...
class FOOTDataset(JointsDataset):
    ...
    def __init__(self, cfg, root, image_set, is_train, transform=None):
        ...
        self.sigmas = np.array([0.068, 0.066, 0.066, 0.092, 0.094, 0.094])
    ...
    def _do_python_keypoint_eval(self, res_file, res_folder=None):
        ...
        coco_eval = COCOeval(self.coco, coco_dt, 'keypoints_foot', self.sigmas)
